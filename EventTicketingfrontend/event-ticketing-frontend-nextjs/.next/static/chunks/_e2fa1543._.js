...
const OrganizerEventsPage = ()=>{
    ...
    const [filterPublished, setFilterPublished] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    // Load user's events
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrganizerEventsPage.useEffect": ()=>{
            if (user && isOrganizer) {
                fetchMyEvents();
    ...
    const fetchMyEvents = async ()=>{
        try {
            ...
            console.log('Loaded my events:', eventsData);
            // Debug: Check date formats and all properties
            if (eventsData.length > 0) {
                // Temporarily disable debug logs to reduce console noise
                // console.log('Sample event date format:', {
                //     eventDate: eventsData[0].eventDate,
                //     endDate: eventsData[0].endDate,
                //     createdAt: eventsData[0].createdAt
                // });
                // console.log('Full first event with all properties:');
                // console.log(JSON.stringify(eventsData[0], null, 2));
                // For now, just log that events were loaded
    ...
    const filteredEvents = events.filter((event)=>{
        ...
        const matchesSearch = event.title?.toLowerCase().includes(searchLower) || event.description?.toLowerCase().includes(searchLower) || event.shortDescription?.toLowerCase().includes(searchLower) || event.venueName?.toLowerCase().includes(searchLower) || event.venueCity?.toLowerCase().includes(searchLower) || event.categoryName?.toLowerCase().includes(searchLower) || event.organizerName?.toLowerCase().includes(searchLower) || // Search in formatted date
        formatDate(event.startDateTime || event.eventDate).toLowerCase().includes(searchLower) || event.isOnline && 'online'.includes(searchLower) || !event.isOnline && ('in-person'.includes(searchLower) || 'physical'.includes(searchLower)) || // Search in ticket and revenue info
        event.ticketsSold?.toString().includes(searchTerm) || event.currency?.toLowerCase().includes(searchLower) || event.isPublished && ('published'.includes(searchLower) || 'live'.includes(searchLower)) || !event.isPublished && ('draft'.includes(searchLower) || 'unpublished'.includes(searchLower));
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Manage your events and track their performance"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/organizer/events/page.tsx",
                                        lineNumber: 247,
                                        columnNumber: 29
                    ...
                    children: [
                        ...
                        filteredEvents.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                events.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: ()=>router.push('/organizer/events/create'),
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: `px-2 py-1 rounded-full text-xs font-medium ${event.isPublished || false ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'}`,
                                                                    children: event.isPublished || false ? 'Published' : 'Draft'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/organizer/events/page.tsx",
                                                                    lineNumber: 358,
                                                                    columnNumber: 57
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                event.categoryName && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            ...
                                                            className: `p-2 rounded-lg transition-colors ${event.isPublished ? 'text-orange-600 hover:bg-orange-50' : 'text-green-600 hover:bg-green-50'}`,
...
_s(OrganizerEventsPage, "H+/ms0im+7IXO5HX5A5Jri/lzIw=", false, function() {
    return [
...
_c = OrganizerEventsPage;
const __TURBOPACK__default__export__ = OrganizerEventsPage;
var _c;
__turbopack_context__.k.register(_c, "OrganizerEventsPage");
...
//# sourceMappingURL=_e2fa1543._.js.map