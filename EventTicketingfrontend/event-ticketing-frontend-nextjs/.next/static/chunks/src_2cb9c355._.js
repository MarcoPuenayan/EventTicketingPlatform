...
const LanguageSettings = ({ onLanguageChange, onPreferenceChange, userPreferences, disabled = false })=>{
    _s();
    const { currentLanguage, changeLanguage, t, formatDate, formatTime, formatCurrency } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSafeI18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useI18n"])();
    ...
    const selectedLangData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSafeI18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SUPPORTED_LANGUAGES"].find((lang)=>lang.code === selectedLanguage) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSafeI18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SUPPORTED_LANGUAGES"][0];
    // Filter languages based on search
    const filteredLanguages = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSafeI18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SUPPORTED_LANGUAGES"].filter((lang)=>lang.name.toLowerCase().includes(searchTerm.toLowerCase()) || lang.nativeName.toLowerCase().includes(searchTerm.toLowerCase()) || lang.code.toLowerCase().includes(searchTerm.toLowerCase()));
    const handleLanguageSelect = (languageCode)=>{
        const langData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSafeI18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SUPPORTED_LANGUAGES"].find((lang)=>lang.code === languageCode);
        if (!langData) return;
        // Update language
        if (onLanguageChange) {
...
const OrganizerSettings = ()=>{
    ...
    const { t } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSafeI18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useI18n"])();
...
_s(OrganizerSettings, "OJ5WfQ+2WQfQGqKA9386xcpuAm8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSafeI18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useI18n"],
...
//# sourceMappingURL=src_2cb9c355._.js.map