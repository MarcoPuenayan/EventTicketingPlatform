...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module '@/hooks/useI18n'");
...
;
;
// Safe hook that checks if provider is available
const useSafeI18n = ()=>{
    try {
        const { useI18nContext } = __turbopack_context__.r("[project]/src/components/providers/I18nProvider.tsx [app-client] (ecmascript)");
...
const OrganizerClientLayout = ({ children })=>{
    ...
    // Use safe i18n hook
    const { t, changeLanguage, availableLanguages, currentLanguage } = useSafeI18n();
    // Theme hooks
...
_s(OrganizerClientLayout, "XTyEqRp7hbJHy7uHktrB8jOqkuY=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5f1b2f4d._.js.map